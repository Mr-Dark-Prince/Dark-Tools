...
@Client.on_message(filters.command("spam", prefixes=f"{HNDLR}") & filters.me)
...
@Client.on_message(filters.command("fastspam", prefixes=f"{HNDLR}") & filters.me)
...
@Client.on_message(filters.command("slowspam", prefixes=f"{HNDLR}") & filters.me)
